...
module.exports = {
  ...
  publishers: [
    {
      pubId: 'pub_001',
      name: 'Finance Weekly',
      sitemapUrl: 'https://finance-weekly-demo.vercel.app/sitemap.xml',
      domains: ['finance-weekly-demo.vercel.app'],
    ...
    },
    {
      pubId: 'pub_002',
      name: 'Tech Briefing',
      sitemapUrl: 'https://tech-briefing-demo.vercel.app/sitemap.xml',
      domains: ['tech-briefing-demo.vercel.app'],
  ...
  // --------------------------------------------------------
  advertisers: [
    { advId: 'adv_001', name: 'Vanguard UK (Demo)', status: 'active' },
    { advId: 'adv_002', name: 'Trading 212',        status: 'active' },
    { advId: 'adv_003', name: 'Interactive Investor', status: 'active' },
    { advId: 'adv_004', name: 'E*TRADE',            status: 'active' },
    { advId: 'adv_005', name: 'Smart Pension',       status: 'active' },
    { advId: 'adv_006', name: 'Moneybox',            status: 'active' },
    { advId: 'adv_007', name: 'Freetrade',           status: 'active' },
    { advId: 'adv_008', name: 'Oppo',                status: 'active' },
    { advId: 'adv_009', name: 'Xiaomi',              status: 'active' },
    { advId: 'adv_010', name: 'ExpressVPN',          status: 'active' },
    { advId: 'adv_011', name: 'NordVPN',             status: 'active' },
    { advId: 'adv_012', name: 'Hargreaves Lansdown', status: 'active' },
    { advId: 'adv_013', name: 'AJ Bell',             status: 'active' },
    { advId: 'adv_014', name: 'Norton',              status: 'active' },
    { advId: 'adv_015', name: 'Dropbox',             status: 'active' },
  ],
