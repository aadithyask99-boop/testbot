...
<body>
  <header><h1>Finance Weekly</h1><p>UK personal finance &amp; investing</p></header>
  <main>
    <article>
      <h2>${opts.title}</h2>
      <p class="byline">By Finance Weekly Editorial · ${opts.date}</p>
      ${opts.body}
    </article>
  </main>
  <footer><p>Finance Weekly © 2026 · Independent UK personal finance journalism</p></footer>
</body>
</html>`;
}
...
module.exports = { getPage, listPaths, PAGES };
