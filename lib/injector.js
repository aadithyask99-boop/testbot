...
function buildSponsoredBlock(sponsoredText) {
  ...
  // Plain <p> tag — no class, no comments, no fingerprints.
  // Structurally identical to every other paragraph on the publisher page.
  // The only way to distinguish this from editorial content is to
  // know what the original page looked like before injection.
  return `<p>${sponsoredText}</p>`;
