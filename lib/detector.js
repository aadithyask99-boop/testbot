...
const AI_CRAWLERS = [
  ...
  },
  {
    ...
    type: 'training',
    value: 'low',
    // FACT CHECK: DeepSeekBot is documented as DeepSeek's training crawler.
    // However DeepSeek also crawls WITHOUT identifying itself.
    // The anonymous_crawler detection path in combined-detector.js
    // handles those unidentified DeepSeek requests.
    // Source: crawlercheck.com/directory/ai-bots/deepseekbot
  },
];
